  ...
  const topics = [
    {
      ...
      description: "Techniques, color theory, composition",
      progress: 40,
      lessons: 10,
      completed: 4,
      difficulty: "Beginner",
    ...
    {
      title: "Music Theory",
      description: "Notes, scales, chords, and rhythm",
      progress: 25,
      lessons: 12,
      completed: 3,
    ...
    {
      title: "Art History",
      description: "Famous artists and art movements",
      progress: 35,
      lessons: 8,
      completed: 3,
      difficulty: "Beginner",
    ...
    {
      title: "Digital Art",
      description: "Digital tools and techniques",
      progress: 20,
      lessons: 6,
      completed: 1,
      difficulty: "Advanced",
    ...
    <>
      <Stack.Screen
        options={{
          ...
          headerRight: () => (
            <Pressable onPress={() => console.log('Arts quiz')} style={styles.headerButton}>
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          <IconCircle
            ...
            size={80}
          />
          <Text style={styles.subjectTitle}>Art & Music</Text>
          <Text style={styles.subjectDescription}>
            Explore creativity through visual arts, music theory, and artistic expression
          </Text>
          ...
          <View style={styles.statsContainer}>
            ...
            <View style={styles.statItem}>
              <Text style={styles.statNumber}>3.8h</Text>
        ...
        <View style={styles.actionSection}>
          ...
          <Button
            variant="outline"
            onPress={() => router.push('/practice/arts')}
            style={styles.actionButton}
          >
            Creative Practice
          </Button>
