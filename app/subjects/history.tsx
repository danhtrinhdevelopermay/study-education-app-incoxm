...
export default function HistoryScreen() {
  const topics = [
    ...
    {
      title: "World Wars",
      description: "WWI, WWII, and their impact",
      progress: 50,
      lessons: 14,
      completed: 7,
      difficulty: "Advanced",
    ...
    <>
      <Stack.Screen
        options={{
          ...
          headerRight: () => (
            <Pressable onPress={() => console.log('History quiz')} style={styles.headerButton}>
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        <View style={styles.header}>
          ...
          <Text style={styles.subjectDescription}>
            Journey through time from ancient civilizations to modern world events
          </Text>
          ...
          <View style={styles.statsContainer}>
            ...
            <View style={styles.statItem}>
              <Text style={styles.statNumber}>6.2h</Text>
